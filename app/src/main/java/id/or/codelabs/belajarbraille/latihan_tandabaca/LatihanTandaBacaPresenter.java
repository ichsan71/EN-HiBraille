...
public class LatihanTandaBacaPresenter implements LatihanTandaBacaContract.Presenter{

    List<TandaBacaModel> tandaBacaDataSet = new ArrayList<>();
    private final LatihanTandaBacaContract.View latihanTandaBacaView;

    public LatihanTandaBacaPresenter(LatihanTandaBacaContract.View latihanTandaBacaView) {
        this.latihanTandaBacaView = latihanTandaBacaView;
    }
    ...
    public void loadTandaBacaData() {
        ...
        latihanTandaBacaView.showTandaBacaData(tandaBacaDataSet);
    }
