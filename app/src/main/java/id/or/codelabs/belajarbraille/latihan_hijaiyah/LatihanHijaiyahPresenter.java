...
public class LatihanHijaiyahPresenter implements LatihanHijaiyahContract.Presenter{
    List<HijaiyahModel> hijaiyahDataSet = new ArrayList<>();
    private final LatihanHijaiyahContract.View latihanHijaiyahView;

    public LatihanHijaiyahPresenter(LatihanHijaiyahContract.View latihanHijaiyahView) {
