...
public class LearnBrailleMergePresenter implements LearnBrailleMergeContract.Presenter {
    ...
    private final LearnBrailleMergeContract.View belajarPenggabunganView;

    public LearnBrailleMergePresenter(LearnBrailleMergeContract.View belajarPenggabunganView) {
