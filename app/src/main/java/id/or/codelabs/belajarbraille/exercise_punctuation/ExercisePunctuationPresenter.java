...
public class ExercisePunctuationPresenter implements ExercisePunctuationContract.Presenter{
    ...
    private final ExercisePunctuationContract.View latihanTandaBacaView;

    public ExercisePunctuationPresenter(ExercisePunctuationContract.View latihanTandaBacaView) {
