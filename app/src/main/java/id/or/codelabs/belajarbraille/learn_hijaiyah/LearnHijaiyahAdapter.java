...
public class LearnHijaiyahAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public LearnHijaiyahAdapter(Context context, List<HijaiyahModel> hijaiyahDataSet,
